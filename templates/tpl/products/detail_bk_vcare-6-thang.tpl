            ...
            <div class="product">
                <div class="bgheading clearfix mt20">
                    <div class="leftimg">
                        ...
                        <div class="accessories mt20">
                            ...
                            <!--{if $smarty.session.showCity eq 1}-->
                                <!--{if $detail.typebaove neq 1}-->
                                    <!--{$detail.chedobaohanh_vn}-->
                                <!--{else}-->
                                    <!--{$iphoneBaohanh.content_vn}-->
                                <!--{/if}-->
                            <!--{else}-->
                            	<!--{if $detail.typebaove neq 1}-->
                                    <!--{$detail.chedobaohanh_en}-->
                                <!--{else}-->
                                    <!--{$iphoneBaohanh.content_en}-->
                                <!--{/if}-->
                            <!--{/if}-->				
                       </div>
                    ...
                    <div class="righttext">
                        ...
                        <div class="PriceDt">
                            <span class="price_ez"> <!--{if $detail.$price eq 0}-->Giá liên hệ<!--{else}--> <!--{$detail.$price|number_format:0:",":"."}--> VNĐ<!--{/if}-->  <!--{insert name="tinhtranghang" active=$detail.typepr}--> </span>&nbsp;
                        </div>
                        <div class="PriceDt">
                            <span class="price_ez1"> Mua trả góp chỉ từ : <span id="showTratruoc" class="price_ez2"></span> <span class="price_ez2">VNĐ</span></span>&nbsp;
                            <script type="text/javascript">
                        ...
                        <div class="accessories mt20">
                            ...
                            <!--{if $smarty.session.showCity eq 1}-->
                                <!--{if $detail.typeiphone neq 1}-->
                                    <!--{$detail.promotion_vn}-->
                                <!--{else}-->
                                    <!--{$iphonePromotion.content_vn}-->
                                <!--{/if}-->
                            <!--{else}-->
                            	<!--{if $detail.typeiphone neq 1}-->
                                    <!--{$detail.promotion_en}-->
                                <!--{else}-->
                                    <!--{$iphonePromotion.content_en}-->
                                <!--{/if}-->    
                            <!--{/if}-->		
                       </div>
                       
                        <div>
                            <strong class="color">Bộ Sản Phẩm Chuẩn: </strong>
                        ...
                        <div style="width:100;">
                            ...
                            <div class="wrap-buy" style="float:right;">
                            	<div style="width:100%">
                                    <img style="float:left; position:relative;top:13px;" src="<!--{$path_url}-->/images/icon_aarrow.gif">
                                                ...
                                                <div class="DialogLeft">
                                                    <div class="media-box clearfix" style="border:none;">
                                                        ...
                                                        <div class="media-img pull-left">
                                                             ...
                                                             <div>
                                                             	<!--{if $detail.vcare gt 0}-->
                                                             	<input class="checkboxBuy" value="<!--{$detail.vcare}-->" id="Vcare" type="checkbox" name="Vcare" onclick="getVcare();" /> 
                                                                Gói bảo hành Vcare 6 tháng
                                                                	
                                                                <!--{/if}-->
                                                                <!--{if $detail.vcare12 gt 0}-->
                                                                <br />
                                                                <input class="checkboxBuy" value="<!--{$detail.vcare12}-->" id="Vcare12" type="checkbox" name="Vcare12" onclick="getVcare12();" /> 
                                                                Gói bảo hành Vcare 12 tháng	
                                                                <!--{else}-->
