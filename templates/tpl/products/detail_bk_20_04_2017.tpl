                ...
                <div class="bgheading clearfix mt20">
                    <div class="leftimg">
                        ...
                        <div class="PriceDtMb">
                            ...
                            <div class="PriceDt">
                                ...
                                <span class="price_ez"> <span id="priceAllMb"><!--{if $checkSoluong eq 1}--><!--{$detail.$price|number_format:0:",":"."}--> VNĐ<!--{else}--> Liên Hệ <!--{/if}--></span> </span>
                                <!--{if $checkPhuKien neq 1}-->
                                    <!--{if $checkSoluong eq 1}--><br /><strong class="colo-white" style="text-transform:uppercase;">Giá Đã Gồm Bảo Hành Nguồn, Màn Hình, Cảm Ứng</strong><!--{/if}-->
                                <!--{/if}-->
                            </div>
                            <!--{if $checkBonho eq 1 && $tinhtrangdt eq ''}-->
                                <div class="all-bonho">
                                    <strong class="chonbonho">Chọn Bộ Nhớ:</strong>
                                    <select name="idbonho1" id="getidbonho1" onchange="priceBonho(this.value,<!--{$detail.idsp}-->,'')">	
                                         <!--{section name=i loop=$bonho}-->
                                            <option class="option" value="<!--{$bonho[i].id}-->"><!--{$bonho[i].name_vn}--></option>
                                         <!--{/section}-->
                                    </select> 
                                </div>
                            <!--{/if}-->
                           ...
                           <div style="width:100%;">
                                        ...
                                        <a data-toggle="modal" title="ĐẶT HÀNG NGAY" href="#quick_order">
                                            <div class="btn_buy_big">
                                               ĐẶT GIỮ HÀNG TẠI SHOP <br />
                                                <span class="fonttextctpr">(Tư vấn miễn phí, không mua không sao)</span>
                                            </div>
                                        </a>
                                    <!--{else}-->
                                ...
                                <div class="wrap-buy" style="float:right;">
                                    ...
                                    <!--{if $checkPhuKien neq 1}--> 
                                        <!--{if $checkSoluong eq 1}-->
                                            <a title="TÍNH TRẢ GÓP" id="buytragopMb" href="<!--{$path_url}-->/tra-gop/<!--{$detail.idsp}-->/">
                                                <div class="btn_buy_big tragop">
                                                    MUA TRẢ GÓP <br />
                                                    <span class="fonttextctpr">Trả trước chỉ từ: <span id="showTratruocMb"></span> vnđ</span>
                                                </div>
                                            </a>
                                        <!--{else}-->
                            	...
                            	<div class="faceshare">	
                                 ...
                                 <script  type="text/javascript">
									...
									function favourite(idpr){
										jQuery.post('/loading/thanhvien.php',{
											type: 'like',
											idpr:idpr
										},function(data) {
                       ...
                       <div class="accessories mt20">
                            <!--{if $smarty.session.showCity eq 1}-->
                                <label class="color"><!--{insert name='getnambaohanh' cid = 172}--></label><br>
                                <!--{insert name='getChedobaohanh' cid = 172}-->	
                             <!--{else}-->
                                <label class="color"><!--{insert name='getnambaohanh' cid = 172}--></label><br>
                                <!--{insert name='getChedobaohanh' cid = 172}-->	
                            <!--{/if}-->    
                    ...
                    <div class="righttext">
                    	<div class="PriceDtPc">
                            ...
                            <div class="PriceDt">
                                <!--{insert name="tinhtranghang" active=$detail.typepr assign="tinhtrangdt"}-->
                                <span class="price_ez"> <span id="priceAll"><!--{if $checkSoluong eq 1}--><!--{$detail.$price|number_format:0:",":"."}--> VNĐ<!--{else}--> Liên Hệ <!--{/if}--></span> </span>
                                <!--{if $checkPhuKien neq 1}-->
                                    <!--{if $checkSoluong eq 1}--><br /><strong class="colo-white" style="text-transform:uppercase;">Giá Đã Gồm Bảo Hành Nguồn, Màn Hình, Cảm Ứng</strong><!--{/if}-->
                                <!--{/if}-->
                            </div>
                            <!--{if $checkBonho eq 1 && $tinhtrangdt eq ''}-->
                                <div class="all-bonho">
                                    <strong class="chonbonho">Chọn Bộ Nhớ:</strong>
                                    <select name="idbonho" id="getidbonho" onchange="priceBonho(this.value,<!--{$detail.idsp}-->,'')">	
                                         <!--{section name=i loop=$bonho}-->
                                            <option class="option" value="<!--{$bonho[i].id}-->"><!--{$bonho[i].name_vn}--></option>
                                         <!--{/section}-->
                                    </select> 
                           ...
                           <div style="width:100%;">
                                ...
                                <div class="wrap-buy" style="float:right;">
                                    ...
                                    <!--{if $checkPhuKien neq 1}--> 
                                        <!--{if $checkSoluong eq 1}-->
                                            <a title="TÍNH TRẢ GÓP" id="buytragop" href="<!--{$path_url}-->/tra-gop/<!--{$detail.idsp}-->/">
                                                <div class="btn_buy_big tragop">
                                                    MUA TRẢ GÓP <br />
                                                    <span class="fonttextctpr">Trả trước chỉ từ: <span id="showTratruoc"></span> vnđ</span>
                                                </div>
                                            </a>
                                        <!--{else}-->
                                            <a title="TÍNH TRẢ GÓP" data-toggle="modal" href="#no_quick_order">
                                ...
                                <script>
                                    $(document).ready(function() {
                                        var getidbonho1 = $('#getidbonho').val();
                                        $('#idbonho').val(getidbonho1);
                                        priceBonho(getidbonho1,<!--{$detail.idsp}-->,'');
                                    });
    
                                    function priceBonho(idbonho,idpr,nameBonho){
                                        if(idbonho > 0)
											idbonho = idbonho
										else
											idbonho = 1;
                                        var url = '<!--{$path_url}-->/tra-gop/'+idpr+'/'+idbonho+'/';
                                        $('#buytragop').attr('href',url);
										$('#buytragopMb').attr('href',url);
                                        //////////////End tra gop////////////
                                        $.post('<!--{$path_url}-->/loading/getPage.php',{idbonho:idbonho,idpr:idpr,type:'priceBonho'},function(data) {
                                             var obj = jQuery.parseJSON(data);
											 if(Math.round(obj.priceBonho) > 0){ 
												 $('#priceAll').html(obj.priceAll+' VNĐ');
												 $('#priceAllMb').html(obj.priceAll+' VNĐ');
											 }
											 else{
												 $('#priceAll').html('Liên Hệ');
												 $('#priceAllMb').html('Liên Hệ');	 
											 }
                                             $('#showPrice').html(obj.priceAll);
                                ...
                                <script type="text/javascript">
                                    ...
                                    $("#showTratruocMb").html(formatNumber(tratruoc));
                             ...
                             <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <div class="modal-title" style="color:#FFF;"><span><!--{$tinhtrangdt}--></span></div>
                                    </div>
                                            ...
                                            <div style="padding:0 20px 20px 20px;">
                                                <div class="DialogLeft">
                                                    <div class="media-box clearfix" style="border:none;">
                                                         <div class="name"><!--{$detail.$name}--> <span id="nameBonho"></span> </div>
                                                ...
                                                <div class="DialogRight">
                                                    ...
                                                    <input type="hidden" name="idbonho" id="idbonho" value="1" />
                                                    <input type="hidden" name="priceBonho" id="priceBonho" value="0" />
