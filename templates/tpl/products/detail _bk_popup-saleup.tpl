...
<div class="modal fade" id="popup-maggiamgia">
    <div class="modal-dialog" style="max-width:500px; padding-top:12%;">
        <div class="modal-content">
            <div class="main-saleup" <!--{if $saleup.img_vn neq ''}-->style="background:url(<!--{$path_url}-->/<!--{$saleup.img_vn}-->) no-repeat;"<!--{/if}-->>
            	<button type="button" class="close" onclick="return goSaleUp(2);" >✕</button>
