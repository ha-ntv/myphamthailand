                        	...
                        	<td valign="top" colspan="2"> 
                                ...
                                <div class="TragopProductsctR">
                                    <div class="content">
                                        ...
                                        <div class="tragop-right">
                                        	<label>Giá bán</label>:
                                            <strong><span class="status"><!--{$view.$price|number_format:0:",":"."}--> </span> <span class="status1">VNĐ</span></strong>
                                        </div>
                                        ...
                                        <p><strong class="color">Giá Trả Trước Và Góp Mỗi Tháng Chỉ Mang Tính Chất Tham Khảo.</strong></p>	
                                    </div>
                                </div>
                            </td>
                        </tr>
