                                    ...
                                    <div class="DialogLeft">
                                        <div class="media-box clearfix" style="border:none;">
                                            ...
                                            <div class="media-img pull-left">
                                                ...
                                                <div>
                                                    <!--{if $view.vcare gt 0}-->
                                                    <input class="checkboxBuy" value="<!--{$view.vcare}-->" id="Vcare" type="checkbox" name="Vcare" onclick="getVcare();" /> 
                                                    Gói bảo hành Vcare 6 tháng
                                                        
                                                    <!--{/if}-->
                                                    <!--{if $view.vcare12 gt 0}-->
                                                    <br />
                                                    <input class="checkboxBuy" value="<!--{$view.vcare12}-->" id="Vcare12" type="checkbox" name="Vcare12" onclick="getVcare12();" /> 
