                        	...
                        	<td valign="top" colspan="2"> 
                                ...
                                <div class="TragopProductsctR">
                                    <div class="content">
                                        ...
                                        <input type="hidden" name="priceTotal" value="<!--{$view.$price}-->" id="priceTotal" />
                                        ...
                                        <div class="tragop-right">
                                        	<label>Giá bán</label>:
                                            <strong><span class="status" id="priceShow"><!--{$view.$price|number_format:0:",":"."}--> </span> <span class="status1">VNĐ</span></strong>
                                        </div>
                                ...
                                <div style="padding:0 20px 20px 20px;">
                                    <div class="DialogLeft">
                                        <div class="media-box clearfix" style="border:none;">
                                             <div class="name" id="nameSearchPrBuyNow"><!--{$view.$name}--> <span id="nameBonho"><!--{$nameBonho}--></span></div>
