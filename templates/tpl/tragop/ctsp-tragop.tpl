                        	...
                        	<td valign="top" colspan="2"> 
                                ...
                                <div class="TragopProductsctR">
                                    <div class="content">
                                    	...
                                    	<input type="hidden" value="<!--{$priceBonho}-->"  name="priceBonho" id="priceBonho" />
                                        <input type="hidden" name="idcolorsize" id="idcolorsize" value="<!--{$viewcolorpr.idcolorsize}-->" />
                                        <input type="hidden" name="idcolor" id="idcolor" value="<!--{$viewcolorpr.idcolor}-->" />
                                        <input type="hidden" value="<!--{$priceshow}-->" id="pricepr" />
                                        <input type="hidden" name="priceTotal" value="<!--{$priceshow}-->" id="priceTotal" />
                                        ...
                                        -->
                                         <div class="tragop-right">
                                            ...
                                            <!--{if $view.typebspchuan gt 0}-->
                                                <!--{insert name='getChedobaohanh' cid = $view.typebspchuan}-->	
                                            <!--{else}-->
                                                <!--{if $smarty.session.showCity eq 1}-->
                                                    <!--{$view.bosanphamchuan_vn}-->
                                                 <!--{else}-->
                                                    <!--{$view.bosanphamchuan_en}-->
                                                <!--{/if}-->    
                                        ...
                                        <div class="tragop-right all-bonho">
                                            ...
                                            <select name="idbonho" onchange="priceBonhoLoad(this.value,<!--{$view.idsp}-->)">	
                                                 <!--{section name=i loop=$bonho}-->
                                                    <option class="option" value="<!--{$bonho[i].id}-->" <!--{if $idbonho eq $bonho[i].id}--> selected="selected" <!--{/if}-->><!--{$bonho[i].name_vn}--></option>
                                                 <!--{/section}-->
                                            </select> 
                                        ...
                                        <!--{/if}-->
                                        <!--{if $view.luuysanpham_vn neq ''}-->
                                            <div class="all-bonho chuysanpham">
                                                <strong>Lưu ý: </strong><!--{$view.luuysanpham_vn}-->
                                            </div>
                                        <!--{/if}-->
                                        <span id="showcolor"><!--{$showcolor}--></span>
										<script>
                                        	function priceColor(idcolorsize,idcolor){
												...
												$('#idcolor').val(idcolor);
												$.post('<!--{$path_url}-->/loading/getPage.php',{idcolorsize:idcolorsize,idcolor:idcolor,type:'priceColor'},function(data) {
													 var obj = jQuery.parseJSON(data);
													 $('#pricepr').val(obj.priceBonho);
													  $('#priceBonho').val(obj.priceBonho);
													 $('#priceTotal').val(obj.priceBonho);
                                        ...
                                        <div class="tragop-right">
                                            ...
                                            <strong><span class="status" id="priceShow">
                                            	<!--{if $viewcolorpr.price_vn gt 0}-->
                                            		<!--{$viewcolorpr.price_vn|number_format:0:",":"."}--> 
                                                <!--{else}-->    
                                                   	<!--{$view.$price|number_format:0:",":"."}--> 
                                                <!--{/if}-->
                                        ...
                                        <div class=" select-box mt10">
                                            <select name="slpercent" onchange="getCountPercent()" id="slpercent">
                                                ...
                                                <option value="20" <!--{if $slpercent eq 20}-->selected="selected"<!--{/if}--> >Trả trước 20%</option>
                                                <option value="30" <!--{if $slpercent eq 30}-->selected="selected"<!--{/if}-->>Trả trước 30%</option>
                                                <option value="40" <!--{if $slpercent eq 40}-->selected="selected"<!--{/if}-->>Trả trước 40%</option>
                                                <option value="50" <!--{if $slpercent eq 50}-->selected="selected"<!--{/if}-->>Trả trước 50%</option>
                                                <option value="60" <!--{if $slpercent eq 60}-->selected="selected"<!--{/if}-->>Trả trước 60%</option>
                                                <option value="70" <!--{if $slpercent eq 70}-->selected="selected"<!--{/if}-->>Trả trước 70%</option>
                                            </select>
                                        </div>
                                        <div class="select-box">
                                            <select name="slmonth" onchange="getCountPercent()" id="slmonth">
                                                <option value="6" <!--{if $slmonth eq 6}-->selected="selected"<!--{/if}-->>Thời gian vay 6 tháng</option>
                                                <option value="9" <!--{if $slmonth eq 9}-->selected="selected"<!--{/if}-->>Thời gian vay 9 tháng</option>
                                                <option value="12" <!--{if $slmonth eq 12}-->selected="selected"<!--{/if}-->>Thời gian vay 12 tháng</option>
                                            </select>
                                        </div>
                            ...
                            <td align="center" id="result" colspan="2">
                            	...
                            	<div class="tragopbank">
                                	<!--{section name=i loop=$bannerBank}-->
                                         <a onclick="btn_tragop(<!--{$bannerBank[i].id}-->)" href="#quick_order" data-toggle="modal">
                                            <div class="logo-item">
                                            	<!--{$bannerBank[i].title_vn}-->
                                                <div class="tgbutton"><span><!--{$bannerBank[i].nameshort_vn}--></span></div>
                                ...
                                <div style="padding:0 20px 20px 20px;">
                                    <div class="DialogLeft">
                                        <div class="media-box clearfix" style="border:none;">
                                             <div class="name" id="nameSearchPrBuyNow"><!--{$view.$name}--> <span id="nameBonho"><!--{$nameBonho}--></span> <span id="nameColor"> - <!--{$nameColor}--></span></div>
