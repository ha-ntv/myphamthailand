<?php /* Smarty version 2.6.6, created on 2016-03-08 04:42:36
         compiled from permission/edit.tpl */ ?>
<div class="WrapContent">
	<div class="dashboardBox">
		<div class="homeTtile">
        	Phân Quyền <?php echo $this->_tpl_vars['viewuser']['username']; ?>

        </div>
       	<form name="allsubmit" id="allsubmit" action="<?php echo $this->_tpl_vars['path_url']; ?>
/permission/editsm/" method="post" enctype="multipart/form-data">
