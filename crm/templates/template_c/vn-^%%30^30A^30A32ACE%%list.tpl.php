<?php /* Smarty version 2.6.6, created on 2016-03-19 09:34:31
         compiled from phieu-xuat-hang/list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('insert', 'HearderCat', 'phieu-xuat-hang/list.tpl', 7, false),array('insert', 'countXuatKho', 'phieu-xuat-hang/list.tpl', 56, false),array('function', 'cycle', 'phieu-xuat-hang/list.tpl', 40, false),)), $this); ?>
...
/phieu-xuat-hang/<?php echo $this->_tpl_vars['view'][$this->_sections['i']['index']]['maphieu']; ?>
/view-dt/'">
...
/view-dt/'">
                    	<?php require_once(SMARTY_CORE_DIR . 'core.run_insert_handler.php');
echo smarty_core_run_insert_handler(array('args' => array('name' => 'countXuatKho', 'act' => 'soluongnhapPhieuXuatHang', 'maphieu' => $this->_tpl_vars['view'][$this->_sections['i']['index']]['maphieu'])), $this); ?>
...
/phieu-xuat-hang/2/edit/<?php echo $this->_tpl_vars['view'][$this->_sections['i']['index']]['id']; ?>
/" title="View">
...
/ajax/Checkip.php',{act:'tablePrPhieuXuat',id:idprphieu,maphieu:maphieu},function(data) {
