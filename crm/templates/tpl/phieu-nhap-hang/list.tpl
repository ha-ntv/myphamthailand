        ...
        <div class="AllTitle">
            ...
            <div class="TitleRight">
            	<!--{if $checkPer1 eq "true" }-->
                    <a title="Thêm mới" class="kv2Btn" href="<!--{$path_url}-->/phieu-nhap-hang/2/add/">
       ...
       <table width="100%" border="0">
            ...
            <!--{section name=i loop=$view}-->   
                <tr class="<!--{cycle values='trColorOne,trColorTwo'}-->">
                    ...
                    <td onclick="location.href='<!--{$path_url}-->/phieu-nhap-hang/<!--{$view[i].maphieu}-->/view-dt/'">
                     ...
                     <td onclick="location.href='<!--{$path_url}-->/phieu-nhap-hang/<!--{$view[i].maphieu}-->/view-dt/'">
                    	<!--{insert name="countNhapKho" act='soluongnhapPhieuNhapHang' maphieu=$view[i].maphieu}-->
                    </td>
                    
                    <td align="center">
                    	<!--{if $checkPer3 eq "true" }-->	
                            <a title="Xóa" href="javascript:void(0)" onclick="Dele('<!--{$path_url}-->/phieu-nhap-hang/<!--{$smarty.request.cat1}-->/delete/<!--{$view[i].id}-->/');">
                        ...
                        <!--{if $checkPer2 eq "true" }-->	 
                            <a href="<!--{$path_url}-->/phieu-nhap-hang/2/edit/<!--{$view[i].id}-->/" title="Sửa">
            ...
            <script>
            	function showtb(id,idprphieu,maphieu){
					if($('#tb'+id).css('display')=='none'){
						...
						$.post('<!--{$path_url}-->/ajax/Checkip.php',{act:'tablePrPhieuNhap',id:idprphieu,maphieu:maphieu},function(data) {
