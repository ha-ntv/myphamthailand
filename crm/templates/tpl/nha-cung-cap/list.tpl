        ...
        <div class="AllTitle">
            ...
            <div class="TitleRight">
            	<!--{if $checkPer1 eq "true" }-->
                    <a title="Thêm mới" class="kv2Btn" href="<!--{$path_url}-->/nha-cung-cap/<!--{$smarty.request.cat1}-->/0/add/">
                ...
                <tr class="<!--{cycle values='trColorOne,trColorTwo'}-->">
                    ...
                    <td align="center">
                    	<!--{if $checkPer3 eq "true" }-->	
                            <a title="Xóa" href="javascript:void(0)" onclick="Dele('<!--{$path_url}-->/nha-cung-cap/<!--{$smarty.request.cat1}-->/0/delete/<!--{$view[i].id}-->/');">
                        ...
                        <!--{if $checkPer2 eq "true" }-->      
                            <a href="<!--{$path_url}-->/nha-cung-cap/<!--{$smarty.request.cat1}-->/0/edit/<!--{$view[i].id}-->/" title="Sửa">
