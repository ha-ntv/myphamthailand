<div class="conten_body">
    ...
    <form name="allsubmit" id="frmEdit" action="index.php?do=colorpr&act=
        ...
        <table  width="100%" border="0" cellspacing="15" cellpadding="0">
             ...
             <tr>
                   <td width="30%"  valign="top" align="right">
                    ...
                    <td valign="top" width="70%" align="left">                          
                       <input name="colorpicker" type="color" value="<!--{if $edit.color neq ''}--><!--{$edit.color}--><!--{else}-->#FFFFFF<!--{/if}-->" onchange="newBackgroundColor(colorpicker.value);">                         
                           <input type="text" value="<!--{$edit.color}-->" name="color" class="InputPrice" />
                           <script language="javascript">
							  function newBackgroundColor(color)
							  {
								 document.allsubmit.color.value = color;
							  }
						   </script>
                    </td>
              </tr>
...
<script type="text/javascript">
	function SubmitFromTP(){
		...
		if(code.value.length == ''){
			...
			<!--{if $edit.id eq ''}-->
			jQuery.post('ajax/Checkip.php',{code:code.value,name:name.value,act:'colorpr'},function(data) {
			<!--{else}-->
			jQuery.post('ajax/Checkip.php',{code:code.value,name:name.value,act:'colorpr',id:<!--{$edit.id}-->},function(data) {
			<!--{/if}-->
