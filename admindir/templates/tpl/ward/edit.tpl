<div class="conten_body">
    ...
    <form name="allsubmit" id="frmEdit" action="index.php?do=ward&act=
		<!--{if $smarty.request.act eq 'add' }-->
			addsm
		<!--{else}-->
			editsm
		<!--{/if}-->
		&city_id=<!--{$smarty.request.city_id}-->&district_id=<!--{$smarty.request.district_id}-->&p=<!--{$smarty.request.p}-->" method="post" enctype="multipart/form-data">
                    ...
                    <div class="divtitle">
                        <div class="divleft">
                            <div class="divright divseo">
                            	<input type="hidden" name="district_id" value="<!--{$smarty.request.district_id}-->" />
