            ...
            <div class="divleft">
                <div class="divright link00">
                    ...
                    <div class="acti2"><img src="images/add.png" /> 
                        <a href="javascript:void(0)" title="Add" onclick="ChangeAdd('index.php?do=masanpham&act=add&cid=<!--{$smarty.request.cid}-->&p=<!--{$smarty.request.p}-->');">
                            Thêm mới
                        </a> 
                    </div>
                   
                    <div class="acti2"><img src="images/delete.png" /> 
                       <a href="javascript:void(0)" title="Delete" onclick="ChangeAction('index.php?do=masanpham&act=dellist&cid=<!--{$smarty.request.cid}-->&p=<!--{$smarty.request.p}-->');">
                            Xóa
                        </a> 
                    </div>

                    <div class="acti2"><img src="images/active.png" /> 
                       <a href="javascript:void(0)" title="Còn hàng" onclick="ChangeAction('index.php?do=masanpham&act=show&cid=<!--{$smarty.request.cid}-->&p=<!--{$smarty.request.p}-->')" >
                           Hoạt động
                        </a> 
                    </div>
                    
                    <div class="acti2"><img src="images/inactive.png" /> 
                        <a href="javascript:void(0)" title="Hết hàng" onclick="ChangeAction('index.php?do=masanpham&act=hide&cid=<!--{$smarty.request.cid}-->&p=<!--{$smarty.request.p}-->');">
                            Không hoạt động
                        </a> 
                    ...
                    <div class="acti2"><img src="images/order.png" /> 
                      <a href="javascript:void(0)" title="Order" onclick="ChangeAction('index.php?do=masanpham&act=order&cid=<!--{$smarty.request.cid}-->&p=<!--{$smarty.request.p}-->');">
                            Order
                        </a> 
                            ...
                            <td  align="center" class="brleft paleft pa_t_b  brbottom">
                                <div class="acti">
                                    <img src="images/icon3.gif"  align="left"/> 
                                      <a href="index.php?do=masanpham&act=edit&id=<!--{$view[i].id}-->&cid=<!--{$smarty.request.cid}-->&p=<!--{$smarty.request.p}-->" title="Eidt"> 
                                        Sửa
                                      </a>
                                 </div>
                            </td>
