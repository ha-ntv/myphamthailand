            ...
            <table  width="100%" border="0" cellspacing="15" cellpadding="0">
                  ...
                  <tr>
                       ...
                       <td width="30%"  valign="top" align="right">
                        ...
                        <td valign="top" width="70%" align="left">                          
                          ...
                          <span class="Size"> <!--{if $smarty.request.id eq 81}--> (750 x 442) <!--{elseif $smarty.request.id eq 136}--> (680 x 79) <!--{else}--> (600 x 600) <!--{/if}--> </span>   
                  ...
                  <tr>
                       ...
                       <td valign="top" width="70%" align="left">                          
                          ...
                          <span class="Size"><!--{if $smarty.request.id eq 136}-->(191 x 291) <!--{else}-->(110 x 110) <!--{/if}--></span>   
                       ...
                       <td width="30%"  valign="top" align="right">
                        ...
                        <td valign="top" width="70%" align="left">                          
                            ...
                            <select id="has_menu" name="has_menu" >
                                ...
                                <!--{section name=i loop=$has_menu}-->

                                    <option <!--{if $has_menu[i].id eq $edit.has_menu }--> selected="selected" <!--{/if}--> value="<!--{$has_menu[i].id}-->">
