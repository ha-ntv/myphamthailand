 <div class="conten_body">
   <div class="conten">
                ...
                <div class="divright link00">
                    ...
                    <span style="float:left">
                     ...
                     <div class="acti2"><img src="images/add.png" /> 
                        <a href="javascript:void(0)" title="Add" onclick="ChangeAdd('index.php?do=nicks&act=add&cid=<!--{$smarty.request.cid}-->');">
                            Thêm mới
                        </a> 
                    </div>
                    
                    <div class="acti2"><img src="images/delete.png" /> 
                       <a href="javascript:void(0)" title="Delete" onclick="ChangeAction('index.php?do=nicks&act=dellist&cid=<!--{$smarty.request.cid}-->');">
                            Xóa
                        </a> 
                    </div>
                    
                    <div class="acti2"><img src="images/active.png" /> 
                       <a href="javascript:void(0)" title="Show" onclick="ChangeAction('index.php?do=nicks&act=show&cid=<!--{$smarty.request.cid}-->')" >
                            Hoạt Động
                        </a> 
                    </div>
                    
                    <div class="acti2"><img src="images/inactive.png" /> 
                        <a href="javascript:void(0)" title="Hide" onclick="ChangeAction('index.php?do=nicks&act=hide&cid=<!--{$smarty.request.cid}-->');">
                            Không Hoạt Động
                        </a> 
                    ...
                    <div class="acti2"><img src="images/order.png" /> 
                      <a href="javascript:void(0)" title="Order" onclick="ChangeAction('index.php?do=nicks&act=order&cid=<!--{$smarty.request.cid}-->');">
                            Order
                        </a> 
      ...
      <div class="tbtitle2 link00" >
        <div class="left"></div> 
          <div class="right"></div>
         <form name="f" id="f" method="post"  action="index.php?do=nicks&act=dellist&cid=1">
                        ...
                        <tr class="<!--{cycle values='bgno,bgf2'}-->"  onmouseout="this.className='<!--{$class}-->'" onmouseover="this.className='bgonmose'" id="g<!--{$view[i].mspid}-->">
                            ...
                            <div class="acti">
                                <img src="images/icon3.gif"  align="left"/> 
                                  <a href="index.php?do=nicks&act=edit&id=<!--{$view[i].id}-->&cid=<!--{$smarty.request.cid}-->&p=<!--{$smarty.request.p}-->" title="Eidt"> 
                                  	Sửa
                                  </a>
                             </div>
