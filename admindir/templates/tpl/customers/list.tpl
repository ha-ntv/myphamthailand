 <div class="conten_body">
   <div class="conten">
                ...
                <div class="divright link00">
                    ...
                    <!--{if $checkPer1 eq "true" }-->
                          <div class="acti2"><img src="images/add.png" /> 
                            <a href="javascript:void(0)" title="Add" onclick="ChangeAdd('index.php?do=customers&act=add&khid=<!--{$smarty.request.khid}-->&cid=<!--{$smarty.request.cid}-->');">
                                Thêm mới
                            </a> 
                    	</div>
                    <!--{else}-->  
                    ...
                    <!--{/if}--> 
                     ...
                     <!--{if $checkPer3 eq "true" }--> 
                        <div class="acti2"><img src="images/delete.png" /> 
                           <a href="javascript:void(0)" title="Delete" onclick="ChangeAction('index.php?do=customers&act=dellist&khid=<!--{$smarty.request.khid}-->&cid=<!--{$smarty.request.cid}-->');">
                                Xóa
                            </a> 
                        </div>
                      <!--{else}-->  
                     ...
                     <!--{if $checkPer2 eq "true" }-->
                        <div class="acti2"><img src="images/active.png" /> 
                           <a href="javascript:void(0)" title="Show" onclick="ChangeAction('index.php?do=customers&act=show&khid=<!--{$smarty.request.khid}-->&cid=<!--{$smarty.request.cid}-->')" >
                                Hoạt Động
                            </a> 
                        </div>
                        
                        <div class="acti2"><img src="images/inactive.png" /> 
                            <a href="javascript:void(0)" title="Hide" onclick="ChangeAction('index.php?do=customers&act=hide&khid=<!--{$smarty.request.khid}-->&cid=<!--{$smarty.request.cid}-->');">
                                Không Hoạt Động
                            </a> 
                        ...
                        <div class="acti2"><img src="images/order.png" /> 
                          <a href="javascript:void(0)" title="Order" onclick="ChangeAction('index.php?do=customers&khid=<!--{$smarty.request.khid}-->&act=order&cid=<!--{$smarty.request.cid}-->');">
                                Order
                            </a> 
      ...
      <div class="tbtitle2 link00" >
        <div class="left"></div> 
          <div class="right"></div>
         <form name="f" id="f" method="post"  action="index.php?do=customers&act=dellist&cid=1">
                    ...
                    <td>
                        ...
                        <tr class="<!--{cycle values='bgno,bgf2'}-->"  onmouseout="this.className='<!--{$class}-->'" onmouseover="this.className='bgonmose'" id="g<!--{$view[i].mspid}-->">
                            ...
                            <td  align="left" class="brleft paleft pa_t_b  brbottom linkblack">
                            	<!--{if $view[i].khid eq 0}-->
                                    <a href="index.php?do=customers&khid=<!--{$view[i].id}-->&cid=<!--{$smarty.request.cid}-->&p=<!--{$smarty.request.p}-->"> 
                                        <!--{$view[i].name_vn}-->
                                    </a>
                                <!--{else}-->
                                	<!--{$view[i].name_vn}-->
                                ...
                                <!--{if $checkPer2 eq "true" }-->
                                    <div class="acti">
                                        <img src="images/icon3.gif"  align="left"/> 
                                          <a href="index.php?do=customers&act=edit&khid=<!--{$view[i].khid}-->&id=<!--{$view[i].id}-->&cid=<!--{$smarty.request.cid}-->&p=<!--{$smarty.request.p}-->" title="Eidt"> 
                                            Sửa
                                          </a>
                                     </div>
                                <!--{else}-->
