<div class="conten_body">
        ...
        <form name="allsubmit" id="frmEdit" action="index.php?do=bonho&act=
  ...
  <script type="text/javascript">
	function SubmitFromTP(){
		...
		if(name_vn==''){
			...
			<!--{if $edit.id eq ''}-->
			jQuery.post('ajax/Checkip.php',{name_vn:name_vn,cid:<!--{$smarty.request.cid}-->,act:'bonho'},function(data) {
			<!--{else}-->
			jQuery.post('ajax/Checkip.php',{name_vn:name_vn,cid:<!--{$smarty.request.cid}-->,act:'bonho',id:<!--{$edit.id}-->},function(data) {
			<!--{/if}-->
