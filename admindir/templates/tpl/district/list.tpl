        ...
        <div class="divtitle">
            <div class="divleft">
                <div class="divright">
                    ...
                    <span class="subconten">
                    	<a title="Menu" href="index.php?do=district&city_id=<!--{$smarty.request.city_id}-->">		
                        	Quận Huyện
                    	</a> 
                    </span> 
                </div>
                ...
                <div class="divright link00">
                    ...
                    <!--{if $checkPer1 eq "true" }-->
                        <div class="acti2"><img src="images/add.png" /> 
                            <a href="javascript:void(0)" title="Add" onclick="ChangeAdd('index.php?do=district&act=add&city_id=<!--{$smarty.request.city_id}-->');">
                                Thêm mới
                            </a> 
                        </div>
                    <!--{else}-->  
                    ...
                    <!--{if $checkPer3 eq "true" }--> 
                        <div class="acti2"><img src="images/delete.png" /> 
                           <a href="javascript:void(0)" title="Delete" onclick="ChangeAction('index.php?do=district&act=dellist&city_id=<!--{$smarty.request.city_id}-->');">
                                Xóa
                            </a> 
                        </div>
					<!--{else}-->  
                    ...
                    <!--{if $checkPer2 eq "true" }-->
                        <div class="acti2"><img src="images/active.png" /> 
                           <a href="javascript:void(0)" title="Show" onclick="ChangeAction('index.php?do=district&act=show&city_id=<!--{$smarty.request.city_id}-->')" >
                                Hoạt Động
                            </a> 
                        </div>
                        
                        <div class="acti2"><img src="images/inactive.png" /> 
                            <a href="javascript:void(0)" title="Hide" onclick="ChangeAction('index.php?do=district&act=hide&city_id=<!--{$smarty.request.city_id}-->');">
                                Không Hoạt Động
                            </a> 
                        ...
                        <div class="acti2"><img src="images/order.png" /> 
                          <a href="javascript:void(0)" title="Order" onclick="ChangeAction('index.php?do=district&act=order&city_id=<!--{$smarty.request.city_id}-->');">
                                Order
                            </a> 
                        ...
                        <tr class="<!--{cycle values='bgno,bgf2'}-->"  onmouseout="this.className='<!--{$class}-->'" onmouseover="this.className='bgonmose'" id="g<!--{$view[i].mspid}-->">
                            ...
                            <td align="center" class="brleft paleft pa_t_b  brbottom linkblack">
                             ...
                             <td  align="left" class="brleft paleft pa_t_b  brbottom linkblack">
                                <a href="index.php?do=ward&city_id=<!--{$view[i].city_id}-->&district_id=<!--{$view[i].id}-->" border="0">
                                    <!--{$view[i].name}-->
                                </a>
                            ...
                            <td  align="left" class="brleft paleft pa_t_b  brbottom linkblack">
                            	<!--{$view[i].price|number_format:0:",":"."}--> đ                            
                            </td>
                            	...
                            	<!--{if $checkPer2 eq "true" }-->
                                    <div class="acti">
                                        <img src="images/icon3.gif"  align="left"/> 
                                          <a href="index.php?do=district&act=edit&id=<!--{$view[i].id}-->&city_id=<!--{$smarty.request.city_id}-->&p=<!--{$smarty.request.p}-->" title="Eidt"> 
                                            Sửa
                                          </a>
                                     </div>
                                <!--{else}-->
