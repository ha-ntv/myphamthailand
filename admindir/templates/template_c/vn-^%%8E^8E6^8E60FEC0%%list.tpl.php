<?php /* Smarty version 2.6.6, created on 2019-03-18 09:17:46
         compiled from users/list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'users/list.tpl', 83, false),)), $this); ?>
                ...
                <div class="divright link00">
                    ...
                    <span style="float:left">
                     ...
                     <div class="acti2"><img src="images/add.png" /> 
                        <a href="javascript:void(0)" title="Add" onclick="ChangeAdd('index.php?do=users&act=add&cid=<?php echo $_REQUEST['cid']; ?>
');">
                            Thêm mới
                        </a> 
                    </div>
                    ...
                    <div class="acti2"><img src="images/delete.png" /> 
                       <a href="javascript:void(0)" title="Delete" onclick="ChangeAction('index.php?do=users&act=dellist&cid=<?php echo $_REQUEST['cid']; ?>
');">
                            Xóa
                        </a> 
                    </div>
...
">
                            ...
                            <td  align="left" class="brleft paleft pa_t_b  brbottom linkblack">
                             ...
                             <td  align="center" class="brleft paleft pa_t_b  brbottom">
                                <a href="index.php?do=permission&id=<?php echo $this->_tpl_vars['view'][$this->_sections['i']['index']]['id']; ?>
" title="permission"> 
                            ...
                            <td  align="center" class="brleft paleft pa_t_b  brbottom">
                                <div class="acti">
                                    <img src="images/icon3.gif"  align="left"/> 
                                      <a href="index.php?do=users&act=edit&id=<?php echo $this->_tpl_vars['view'][$this->_sections['i']['index']]['id']; ?>
