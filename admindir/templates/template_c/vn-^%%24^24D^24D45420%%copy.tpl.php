<?php /* Smarty version 2.6.6, created on 2019-03-19 18:02:19
         compiled from products/copy.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('insert', 'HearderCat', 'products/copy.tpl', 6, false),array('insert', 'CopyNews', 'products/copy.tpl', 67, false),array('function', 'cycle', 'products/copy.tpl', 61, false),)), $this); ?>
            ...
            <div class="divleft">
                <div class="divright link00">
                    ...
                    <div class="acti2"><img src="images/copy.png" /> 
                      <a href="javascript:void(0)" title="Order" onclick="ChangeAction('index.php?do=products&act=copysm&id=<?php echo $_REQUEST['id']; ?>
...
');">
      ...
      <div class="tbtitle2 link00" >
        <div class="left"></div> 
          <div class="right"></div>
         <form name="f" id="f" method="post"  action="index.php?do=products&act=copysm&id=<?php echo $_REQUEST['id']; ?>
&cid=<?php echo $_REQUEST['cid']; ?>
&p=<?php echo $_REQUEST['p']; ?>
"> 
...
">
                           ...
                           <?php require_once(SMARTY_CORE_DIR . 'core.run_insert_handler.php');
echo smarty_core_run_insert_handler(array('args' => array('name' => 'CopyNews', 'cid_share' => $this->_tpl_vars['cid_share'], 'id' => $this->_tpl_vars['copy'][$this->_sections['i']['index']]['id'], 'cidother' => $this->_tpl_vars['cidother'], 'num' => $this->_sections['i']['index'])), $this); ?>
