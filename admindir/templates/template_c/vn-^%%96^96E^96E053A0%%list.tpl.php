<?php /* Smarty version 2.6.6, created on 2019-03-19 03:55:31
         compiled from partner/list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('insert', 'HearderCat', 'partner/list.tpl', 6, false),array('function', 'cycle', 'partner/list.tpl', 104, false),)), $this); ?>
                ...
                <div class="divright link00">
                    ...
                    <span style="float:left">
                     ...
                     <div class="acti2"><img src="images/add.png" /> 
                        <a href="javascript:void(0)" title="Add" onclick="ChangeAdd('index.php?do=partner&act=add&cid=<?php echo $_REQUEST['cid']; ?>
');">
                            Thêm mới
                        </a> 
                    </div>
                    ...
                    <div class="acti2"><img src="images/delete.png" /> 
                       <a href="javascript:void(0)" title="Delete" onclick="ChangeAction('index.php?do=partner&act=dellist&cid=<?php echo $_REQUEST['cid']; ?>
');">
                            Xóa
                        </a> 
                    </div>
                    ...
                    <div class="acti2"><img src="images/active.png" /> 
                       <a href="javascript:void(0)" title="Show" onclick="ChangeAction('index.php?do=partner&act=show&cid=<?php echo $_REQUEST['cid']; ?>
')" >
                            Hoạt Động
                        </a> 
                    </div>
                    ...
                    <div class="acti2"><img src="images/inactive.png" /> 
                        <a href="javascript:void(0)" title="Hide" onclick="ChangeAction('index.php?do=partner&act=hide&cid=<?php echo $_REQUEST['cid']; ?>
');">
                            Không Hoạt Động
                        </a> 
                    ...
                    <div class="acti2"><img src="images/order.png" /> 
                      <a href="javascript:void(0)" title="Order" onclick="ChangeAction('index.php?do=partner&act=order&cid=<?php echo $_REQUEST['cid']; ?>
');">
                            Order
                        </a> 
...
" />
                          	...
                          	<td align="center" class="brleft paleft pa_t_b  brbottom linkblack">
                                <?php if ($this->_tpl_vars['view'][$this->_sections['i']['index']]['img_vn'] != ""): ?>
                                    <img align="absmiddle" width="60px"  src="../<?php echo $this->_tpl_vars['view'][$this->_sections['i']['index']]['img_vn']; ?>
"   border="0" />
                                <?php endif; ?>
                            </td> 
                            ...
                            <div class="acti">
                                <img src="images/icon3.gif"  align="left"/> 
                                  <a href="index.php?do=partner&act=edit&id=<?php echo $this->_tpl_vars['view'][$this->_sections['i']['index']]['id']; ?>
