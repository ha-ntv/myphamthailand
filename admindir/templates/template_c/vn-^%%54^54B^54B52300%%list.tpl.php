<?php /* Smarty version 2.6.6, created on 2019-03-18 10:05:47
         compiled from articles/list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('insert', 'HearderCat', 'articles/list.tpl', 6, false),array('function', 'cycle', 'articles/list.tpl', 139, false),)), $this); ?>
                ...
                <div class="divright link00">
                    ...
                    <?php if ($this->_tpl_vars['checkPer1'] == 'true'): ?>
                          <div class="acti2"><img src="images/add.png" /> 
                            <a href="javascript:void(0)" title="Add" onclick="ChangeAdd('index.php?do=articles&act=add&cid=<?php echo $_REQUEST['cid']; ?>
');">
                                Thêm mới
                            </a> 
                    	</div>
                    ...
                    <?php endif; ?> 
                     ...
                     <?php if ($this->_tpl_vars['checkPer3'] == 'true'): ?> 
                        <div class="acti2"><img src="images/delete.png" /> 
                           <a href="javascript:void(0)" title="Delete" onclick="ChangeAction('index.php?do=articles&act=dellist&cid=<?php echo $_REQUEST['cid']; ?>
');">
                                Xóa
                            </a> 
                        </div>
                     ...
                     <?php if ($this->_tpl_vars['checkPer2'] == 'true'): ?>
                        <div class="acti2"><img src="images/active.png" /> 
                           <a href="javascript:void(0)" title="Show" onclick="ChangeAction('index.php?do=articles&act=show&cid=<?php echo $_REQUEST['cid']; ?>
')" >
                                Hoạt Động
                            </a> 
                        </div>
                        ...
                        <div class="acti2"><img src="images/inactive.png" /> 
                            <a href="javascript:void(0)" title="Hide" onclick="ChangeAction('index.php?do=articles&act=hide&cid=<?php echo $_REQUEST['cid']; ?>
');">
                                Không Hoạt Động
                            </a> 
                        ...
                        <div class="acti2"><img src="images/order.png" /> 
                          <a href="javascript:void(0)" title="Order" onclick="ChangeAction('index.php?do=articles&act=order&cid=<?php echo $_REQUEST['cid']; ?>
');">
                                Order
                            </a> 
                                ...
                                <?php if ($this->_tpl_vars['checkPer2'] == 'true'): ?>
                                    <div class="acti">
                                        <img src="images/icon3.gif"  align="left"/> 
                                          <a href="index.php?do=articles&act=edit&id=<?php echo $this->_tpl_vars['view'][$this->_sections['i']['index']]['id']; ?>
