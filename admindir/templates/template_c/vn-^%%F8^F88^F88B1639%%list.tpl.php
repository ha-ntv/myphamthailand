<?php /* Smarty version 2.6.6, created on 2019-03-20 04:34:10
         compiled from colorsize/list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('insert', 'HearderCat', 'colorsize/list.tpl', 11, false),array('insert', 'NameCity', 'colorsize/list.tpl', 240, false),array('function', 'cycle', 'colorsize/list.tpl', 212, false),)), $this); ?>
            ...
            <div class="divleft">
                ...
                <div class="divright link00">
                    ...
                    <div class="acti2"><img src="images/add.png" /> 
                        ...
                        <a href="javascript:void(0)" title="Add" onclick="ChangeAdd('index.php?do=colorsize&act=add&idpr=<?php echo $_REQUEST['idpr']; ?>
...
');">
                    ...
                    <div class="acti2"><img src="images/delete.png" /> 
                       ...
                       <a href="javascript:void(0)" title="Delete" onclick="ChangeAction('index.php?do=colorsize&act=dellist&idpr=<?php echo $_REQUEST['idpr']; ?>
&cid=<?php echo $_REQUEST['cid']; ?>
&p=<?php echo $_REQUEST['p']; ?>
');">
                    ...
                    <div class="acti2"><img src="images/active.png" /> 
                       ...
                       <a href="javascript:void(0)" title="Còn hàng" onclick="ChangeAction('index.php?do=colorsize&act=show&idpr=<?php echo $_REQUEST['idpr']; ?>
&cid=<?php echo $_REQUEST['cid']; ?>
&p=<?php echo $_REQUEST['p']; ?>
')" >
                    ...
                    <div class="acti2"><img src="images/inactive.png" /> 
                        ...
                        <a href="javascript:void(0)" title="Liên hệ" onclick="ChangeAction('index.php?do=colorsize&act=hidekinhdoanh&idpr=<?php echo $_REQUEST['idpr']; ?>
&cid=<?php echo $_REQUEST['cid']; ?>
&p=<?php echo $_REQUEST['p']; ?>
');">
                    ...
                    <div class="acti2"><img src="images/order.png" /> 
                      ...
                      <a href="javascript:void(0)" title="Order" onclick="ChangeAction('index.php?do=colorsize&act=order&idpr=<?php echo $_REQUEST['idpr']; ?>
&cid=<?php echo $_REQUEST['cid']; ?>
&p=<?php echo $_REQUEST['p']; ?>
');">
...
?> 
                         ...
                         <?php if ($this->_tpl_vars['countcity'] > 0 && $this->_tpl_vars['countcity'] == $this->_sections['i']['index']): ?>  
...
echo smarty_core_run_insert_handler(array('args' => array('name' => 'NameCity', 'city_id' => $this->_tpl_vars['view'][$this->_sections['i']['index']]['idcity'])), $this); ?>
                            ...
                            <td  align="center" class="brleft pa_t_b  brbottom">
                               ...
                               <?php if ($this->_tpl_vars['view'][$this->_sections['i']['index']]['in_stock'] == '1'): ?>

                                    Còn hàng

                                 <?php elseif ($this->_tpl_vars['view'][$this->_sections['i']['index']]['in_stock'] == '2'): ?> 
                            ...
                            <td  align="center" class="brleft paleft pa_t_b  brbottom">
                                ...
                                <div class="acti">
                                    ...
                                    <img src="images/icon3.gif"  align="left"/> 
                                      ...
                                      <a href="index.php?do=colorsize&act=edit&id=<?php echo $this->_tpl_vars['view'][$this->_sections['i']['index']]['id']; ?>
&idpr=<?php echo $_REQUEST['idpr']; ?>
&cid=<?php echo $_REQUEST['cid']; ?>
&p=<?php echo $_REQUEST['p']; ?>
" title="Eidt"> 
