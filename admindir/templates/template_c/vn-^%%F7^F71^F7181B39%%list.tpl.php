<?php /* Smarty version 2.6.6, created on 2019-03-19 03:48:14
         compiled from banner/list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('insert', 'HearderCat', 'banner/list.tpl', 6, false),array('function', 'cycle', 'banner/list.tpl', 135, false),)), $this); ?>
                ...
                <div class="divright link00">
                    ...
                    <?php if ($this->_tpl_vars['checkPer1'] == 'true'): ?>
                       <div class="acti2"><img src="images/add.png" /> 
                            <a href="javascript:void(0)" title="Add" onclick="ChangeAdd('index.php?do=banner&act=add&cid=<?php echo $_REQUEST['cid']; ?>
');">
                                Thêm mới
                            </a> 
                        </div>
                    ...
                    <?php endif; ?> 
                     ...
                     <?php if ($this->_tpl_vars['checkPer3'] == 'true'): ?> 
                        <div class="acti2"><img src="images/delete.png" /> 
                           <a href="javascript:void(0)" title="Delete" onclick="ChangeAction('index.php?do=banner&act=dellist&cid=<?php echo $_REQUEST['cid']; ?>
');">
                                Xóa
                            </a> 
                        </div>
                     ...
                     <?php if ($this->_tpl_vars['checkPer2'] == 'true'): ?>
                        <div class="acti2"><img src="images/active.png" /> 
                           <a href="javascript:void(0)" title="Show" onclick="ChangeAction('index.php?do=banner&act=show&cid=<?php echo $_REQUEST['cid']; ?>
')" >
                                Hoạt Động
                            </a> 
                        </div>
                        ...
                        <div class="acti2"><img src="images/inactive.png" /> 
                            <a href="javascript:void(0)" title="Hide" onclick="ChangeAction('index.php?do=banner&act=hide&cid=<?php echo $_REQUEST['cid']; ?>
');">
                                Không Hoạt Động
                            </a> 
                        ...
                        <div class="acti2"><img src="images/order.png" /> 
                          <a href="javascript:void(0)" title="Order" onclick="ChangeAction('index.php?do=banner&act=order&cid=<?php echo $_REQUEST['cid']; ?>
');">
                                Order
                            </a> 
      ...
      <div class="tbtitle2 link00" >
        <div class="left"></div> 
          <div class="right"></div>
         <form name="f" id="f" method="post"  action="index.php?do=banner&act=dellist&cid=1">
...
" />
                          	...
                          	<td align="center" class="brleft paleft pa_t_b  brbottom linkblack">
                                <?php if ($this->_tpl_vars['view'][$this->_sections['i']['index']]['img_vn'] != ""): ?>
                                    <img align="absmiddle" width="100px"  src="../<?php echo $this->_tpl_vars['view'][$this->_sections['i']['index']]['img_vn']; ?>
"   border="0" />
                                <?php endif; ?>
                            </td> 
								 ...
								 <?php if ($this->_tpl_vars['checkPer2'] == 'true'): ?>
                                    <div class="acti">
                                        <img src="images/icon3.gif"  align="left"/> 
                                          <a href="index.php?do=banner&act=edit&id=<?php echo $this->_tpl_vars['view'][$this->_sections['i']['index']]['id']; ?>
