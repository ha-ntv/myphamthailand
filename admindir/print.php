...
$sqlp = "SELECT * FROM $GLOBALS[db_sp].infos where id=65";
$rsp = $GLOBALS["sp"]->getRow($sqlp);


function getNameCrmHDH($code){
	$sql = "SELECT * FROM $GLOBALS[db_crm].serial where code='$code'";
	$rs = $GLOBALS["crm"]->GetRow($sql);
	return $rs['hdh'];
}		
...
if(!empty($rs['phukien'])){
	...
	$strPromotion.= '
		<tr>
			<td align="center" valign="middle">'.$i.'</td>
			<td align="left" valign="middle">'.$rs['phukien'].'</td>
			<td align="left" valign="middle">&nbsp;</td>
			<td align="left" valign="middle">&nbsp;</td>
			<td align="left" valign="middle">&nbsp;</td>
...
if($rs['idbonho'] > 1){
	...
	$bonhomay = '
			<tr>
				<td align="center" valign="middle">'.$i.'</td>
				<td align="left" valign="middle"> Bộ nhớ '.NameTinhThanh('bonho','name_vn',$rs['idbonho']) .'</td>
				<td align="left" valign="middle"></td>
				<td align="left" valign="middle"></td>
				<td align="left" valign="middle"></td>
				<td align="right" valign="middle"></td>
			...
			<td valign="top" align="left">
				<table width="100%" border="1" cellpadding="0" cellspacing="0" style="BORDER-COLLAPSE: collapse;" bordercolor="#333333">
				  ...
				  <tr>
					...
					<td align="left" valign="middle">'.getNameCrmHDH($rs['serial']).'</td>
					<td align="left" valign="middle">1</td>
					...
					<tbody>
						<tr>
							<td align="left" width="30%" valign="top">
								<strong>Khu Vực TPHCM </strong><br>
								<strong>Hotline:</strong> 08.6685.1666
							</td>
							<td align="left" width="30%" valign="top">
								<strong>Khu Vực Đà Nẵng</strong><br>
								<strong>Hotline:</strong> 0511.655.8855
							</td>
							<td align="left" width="40%" valign="top">
								<strong>Web:</strong> www.vietanhmobile.com<br>
								<strong>Email góp ý:</strong>&nbsp; anhnguyen110584@gmail.com
							</td>
						</tr>
					</tbody>
				</table>
