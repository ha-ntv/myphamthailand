<div class="conten_body">
        ...
        <div class="divtitle">
            <div class="divleft">
                <div class="divright">
                    ...
                    <span class="subconten">
                    	<a title="Menu" href="index.php?do=district&city_id=<!--{$smarty.request.city_id}-->&p=<!--{$smarty.request.p}-->">		
                        	Quận Huyện
                    	</a> 
                    </span> 
    ...
    <form name="allsubmit" id="frmEdit" action="index.php?do=district&act=
		<!--{if $smarty.request.act eq 'add' }-->
			addsm
		<!--{else}-->
			editsm
		<!--{/if}-->
		&city_id=<!--{$smarty.request.city_id}-->&p=<!--{$smarty.request.p}-->" method="post" enctype="multipart/form-data">
