                ...
                <div class="divright link00">
					...
					<!--{elseif $smarty.request.s eq 2}--> 
                    	 <!--{if $smarty.session.group_artseed_user eq -1}-->
                            <div class="acti2"><img src="images/duyet-don-hang.png" /> 
                                <a href="javascript:void(0)" title="Duyệt đơn hàng CRM" onclick="return submitSerial();">
                                   Duyệt đơn hàng CRM
                                </a>      
                            </div>
                        <!--{/if}-->	
                    ...
                    <script type="text/javascript">
						...
						function submitSerialgo(){
							...
							/*else if(txthdh.length == ''){
								$('#errmsgSerial').html('Vui lòng nhập vào hệ điều hành máy.');
								return false;
							}*/
								...
								jQuery.post('ajax/Checkip.php',{idorder:idorder,txtserial:txtserial,txthdh:txthdh,idmember:idmember,loaikhachhang:loaikhachhang,act:'duyetdonhang'},function(data) {
        	...
        	<form name="f" id="f" method="post" action="index.php?do=orders&act=serial">
				...
				<link rel="stylesheet" type="text/css" href="js/searchajax/jquery.autocomplete.css" />
                    ...
                    <div style="display:none;">
                        <div id="inline1" style="padding:10px; font-size:13px;width:600px;height:180px;">
