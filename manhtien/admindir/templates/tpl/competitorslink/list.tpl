 <div class="conten_body">
   <div class="conten">
                ...
                <div class="divright link00">
                    ...
                    <!--{if $checkPer1 eq "true" }-->
                          <div class="acti2"><img src="images/add.png" /> 
                            <a href="javascript:void(0)" title="Add" onclick="ChangeAdd('index.php?do=competitorslink&act=add&cid=<!--{$smarty.request.cid}-->&type=<!--{$smarty.request.type}-->');">
                                Thêm mới
                            </a> 
                    	</div>
                    <!--{else}-->  
                    ...
                    <!--{/if}--> 
                     ...
                     <!--{if $checkPer3 eq "true" }--> 
                        <div class="acti2"><img src="images/delete.png" /> 
                           <a href="javascript:void(0)" title="Delete" onclick="ChangeAction('index.php?do=competitorslink&act=dellist&cid=<!--{$smarty.request.cid}-->&type=<!--{$smarty.request.type}-->');">
                                Xóa
                            </a> 
                        </div>
                      <!--{else}-->  
                     ...
                     <!--{if $checkPer2 eq "true" }-->          
                        <div class="acti2"><img src="images/order.png" /> 
                          <a href="javascript:void(0)" title="Order" onclick="ChangeAction('index.php?do=competitorslink&act=order&cid=<!--{$smarty.request.cid}-->&type=<!--{$smarty.request.type}-->');">
                                Order
                            </a> 
                        ...
                        <div class="acti2"><img src="images/copy.png" /> 
                          <a href="javascript:void(0)" title="Thông kê so sánh giá" onclick="ChangeActiongo('index.php?do=competitorslink&act=thongke&cid=<!--{$smarty.request.cid}-->&type=<!--{$smarty.request.type}-->');">
      ...
      <div class="tbtitle2 link00" >
        <div class="left"></div> 
          <div class="right"></div>
         <form name="f" id="f" method="post"  action="index.php?do=competitorslink&act=dellist&cid=1&type=<!--{$smarty.request.type}-->">
                                ...
                                <!--{if $checkPer2 eq "true" }-->
                                    <div class="acti">
                                        <img src="images/icon3.gif"  align="left"/> 
                                          <a href="index.php?do=competitorslink&act=edit&id=<!--{$view[i].id}-->&cid=<!--{$smarty.request.cid}-->&type=<!--{$smarty.request.type}-->&p=<!--{$smarty.request.p}-->" title="Eidt"> 
                                            Sửa
                                          </a>
                                     </div>
                                <!--{else}-->
