                ...
                <div class="divright link00">
                   ...
                   <!--{if $checkPer1 eq "true" }-->
                    ...
                    <!--{if $checkPer2 eq "true" }-->
                        ...
                        <div class="acti2"><img src="images/active.png" /> 
                           <a href="javascript:void(0)" title="Show" onclick="ChangeAction('index.php?do=categories&act=crmshow&cid=<!--{$smarty.request.cid}-->&root=<!--{$smarty.request.root}-->')" >
                                Hoạt Động CRM
                            </a> 
                        </div>
                        
                        <div class="acti2"><img src="images/inactive.png" /> 
                            <a href="javascript:void(0)" title="Hide" onclick="ChangeAction('index.php?do=categories&act=crmhide&cid=<!--{$smarty.request.cid}-->&root=<!--{$smarty.request.root}-->');">
                                Không Hoạt Động CRM
                            </a> 
                         ...
                         <div class="acti2"><img src="images/active.png" /> 
                           <a href="javascript:void(0)" title="Show" onclick="ChangeAction('index.php?do=categories&act=crmhtehangshow&cid=<!--{$smarty.request.cid}-->&root=<!--{$smarty.request.root}-->')" >
                                Hoạt Động Tình Trạng Hết Hàng CRM
                            </a> 
                        </div>
                        
                        <div class="acti2"><img src="images/inactive.png" /> 
                            <a href="javascript:void(0)" title="Hide" onclick="ChangeAction('index.php?do=categories&act=crmhethanghide&cid=<!--{$smarty.request.cid}-->&root=<!--{$smarty.request.root}-->');">
