 <div class="conten_body">
   <div class="conten">
        <div class="divtitle">
            <div class="divleft">
                <div class="divright">
                    ...
                    <span class="subconten"><img style="margin-top:13px" src="images/icon.gif"></span>
                    <span class="subconten">	
                       <a href="index.php?do=tinhthanh&cid=<!--{$smarty.request.cid}-->" >		
            ...
            <div class="divleft">
                <div class="divright link00">
                    ...
                    <div class="acti2"><img src="images/add.png" /> 
                        <a href="javascript:void(0)" title="Add" onclick="ChangeAdd('index.php?do=tinhthanh&act=add&cid=<!--{$smarty.request.cid}-->');">
                            Thêm mới
                        </a> 
                    </div>
                   
                    <div class="acti2"><img src="images/delete.png" /> 
                       <a href="javascript:void(0)" title="Delete" onclick="ChangeAction('index.php?do=tinhthanh&act=dellist&cid=<!--{$smarty.request.cid}-->');">
                            Xóa
                        </a> 
                    </div>

                    <div class="acti2"><img src="images/active.png" /> 
                       <a href="javascript:void(0)" title="Show" onclick="ChangeAction('index.php?do=tinhthanh&act=show&cid=<!--{$smarty.request.cid}-->')" >
                            Hoạt Động
                        </a> 
                    </div>
                    
                    <div class="acti2"><img src="images/inactive.png" /> 
                        <a href="javascript:void(0)" title="Hide" onclick="ChangeAction('index.php?do=tinhthanh&act=hide&cid=<!--{$smarty.request.cid}-->');">
                            Không Hoạt Động
                        </a> 
                    ...
                    <div class="acti2"><img src="images/order.png" /> 
                      <a href="javascript:void(0)" title="Order" onclick="ChangeAction('index.php?do=tinhthanh&act=order&cid=<!--{$smarty.request.cid}-->');">
                            Order
                        </a> 
      ...
      <div class="tbtitle2 link00" >
        <div class="left"></div> 
          <div class="right"></div>
         <form name="f" id="f" method="post"  action="index.php?do=tinhthanh&act=dellist&cid=1">
                    ...
                    <td>
                        <table class="br1"  style="border-bottom:0px" width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="30%"  height="25"  align="center" class="brbottom brleft">
                            ...
                            <td align="center" class="brleft paleft pa_t_b  brbottom linkblack">
                           	...
                           	<!--{if $view[i].has_child eq 1 }-->
                                 <td  align="left" class="brleft paleft pa_t_b  brbottom linkblack">
                                    <a href="index.php?do=tinhthanh&cid=<!--{$view[i].id}-->" border="0">
                                        <!--{$view[i].name_vn}-->
                                    </a>
                            <!--{else}-->
                                <td  align="left" class="brleft paleft pa_t_b  brbottom linkblack">
                            ...
                            <td  align="center" class="brleft paleft pa_t_b  brbottom">
                                <div class="acti">
                                    <img src="images/icon3.gif"  align="left"/> 
                                      <a href="index.php?do=tinhthanh&act=edit&id=<!--{$view[i].id}-->&cid=<!--{$smarty.request.cid}-->&p=<!--{$smarty.request.p}-->" title="Eidt"> 
                                        Sửa
                                      </a>
                                 </div>
                            </td>
