 <div class="conten_body">
   <div class="conten">
            ...
            <div class="divleft">
                <div class="divright link00">
                    ...
                    <div class="acti2"><img src="images/copy.png" /> 
                      <a href="javascript:void(0)" title="Order" onclick="ChangeAction('index.php?do=products&act=copysmsp&id=<!--{$smarty.request.id}-->&cid=<!--{$smarty.request.cid}-->&p=<!--{$smarty.request.p}-->');">
                            Copy
                        </a> 
      ...
      <div class="tbtitle2 link00" >
        <div class="left"></div> 
          <div class="right"></div>
         <form name="f" id="f" method="post"  action="index.php?do=products&act=copysmsp&id=<!--{$smarty.request.id}-->&cid=<!--{$smarty.request.cid}-->&p=<!--{$smarty.request.p}-->"> 
                    ...
                    <td>
                        <table class="br1"  style="border-bottom:0px" width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <!--{section name=i loop=$copy}--> 
                           ...
                           <!--{insert name="Copypr" cid_share=$cid_sharepr id=$copy[i].id cidother=$cidother num=$smarty.section.i.index}-->
                          <!--{/section}-->
