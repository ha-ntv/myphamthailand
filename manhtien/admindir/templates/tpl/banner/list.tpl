                ...
                <div class="divright link00">
                    ...
                    <!--{if $checkPer1 eq "true" }-->
                       <div class="acti2"><img src="images/add.png" /> 
                            <a href="javascript:void(0)" title="Add" onclick="ChangeAdd('index.php?do=banner&act=add&cid=<!--{$smarty.request.cid}-->');">
                                Thêm mới
                            </a> 
                        </div>
                    <!--{else}-->  
                    ...
                    <!--{/if}--> 
                     ...
                     <!--{if $checkPer3 eq "true" }--> 
                        <div class="acti2"><img src="images/delete.png" /> 
                           <a href="javascript:void(0)" title="Delete" onclick="ChangeAction('index.php?do=banner&act=dellist&cid=<!--{$smarty.request.cid}-->');">
                                Xóa
                            </a> 
                        </div>
                      <!--{else}-->  
                     ...
                     <!--{if $checkPer2 eq "true" }-->
                        <div class="acti2"><img src="images/active.png" /> 
                           <a href="javascript:void(0)" title="Show" onclick="ChangeAction('index.php?do=banner&act=show&cid=<!--{$smarty.request.cid}-->')" >
                                Hoạt Động
                            </a> 
                        </div>
                        
                        <div class="acti2"><img src="images/inactive.png" /> 
                            <a href="javascript:void(0)" title="Hide" onclick="ChangeAction('index.php?do=banner&act=hide&cid=<!--{$smarty.request.cid}-->');">
                                Không Hoạt Động
                            </a> 
                        ...
                        <div class="acti2"><img src="images/order.png" /> 
                          <a href="javascript:void(0)" title="Order" onclick="ChangeAction('index.php?do=banner&act=order&cid=<!--{$smarty.request.cid}-->');">
                                Order
                            </a> 
                            ...
                            <td align="center" class="brleft paleft pa_t_b  brbottom linkblack">
                          	...
                          	<td align="center" class="brleft paleft pa_t_b  brbottom linkblack">
                                <!--{if $view[i].img_vn neq ""}-->
                                    <img align="absmiddle" width="100px"  src="../<!--{$view[i].img_vn}-->"   border="0" />
                                <!--{/if}-->
                            </td> 
								 ...
								 <!--{if $checkPer2 eq "true" }-->
                                    <div class="acti">
                                        <img src="images/icon3.gif"  align="left"/> 
                                          <a href="index.php?do=banner&act=edit&id=<!--{$view[i].id}-->&cid=<!--{$smarty.request.cid}-->&p=<!--{$smarty.request.p}-->" title="Eidt"> 
                                            Sửa
                                          </a>
                                     </div>
                                <!--{else}-->
