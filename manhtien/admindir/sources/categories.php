...
$type = array(
   ...
   array('id'=>3,'name'=>'Điện Thoại'),
   array('id'=>5,'name'=>'Máy Tính Bảng'),
   array('id'=>4,'name'=>'Điện Thoại Apple'),
   array('id'=>35,'name'=>'Điện Thoại Samsung'),
   array('id'=>43,'name'=>'Máy Tính Bảng Apple')
);
$smarty->assign("type",$type);

$has_menu = array(
   array('id'=>0,'name'=>'None'),	
   array('id'=>1,'name'=>'Submenu Apple'),
   array('id'=>2,'name'=>'Submenu Sản Phẩm'),
   array('id'=>3,'name'=>'Không Trả Góp')
);
